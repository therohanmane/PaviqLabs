      ...
      <div className="contact-grid">
        <div>
          ...
          <div className="contact-info reveal reveal-delay-3">
            ...
            <div className="contact-info-item">
              ...
              <div>
                ...
                <div className="contact-info-val">Kothrud, Pune, Maharashtra, India — Global Delivery Center & HQ</div>
              </div>
            </div>
          </div>
          ...
          <div className="contact-social-links reveal reveal-delay-4">
            ...
            <a href="https://www.instagram.com/paviqlabs/" target="_blank" rel="noopener noreferrer" className="social-pill">
